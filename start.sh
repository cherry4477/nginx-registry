...
sed -i 's/registry:5000/'$servicename:$serviceport'/g' ${NGINX}/conf/docker-registry.default
sed -i 's/ldap://54.222.156.183:40389/ou=Users,dc=openstack,dc=org?uid?sub?(objectClass=inetOrgPerson)/'$ldap'/g'
